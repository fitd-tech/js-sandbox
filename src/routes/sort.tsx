            ...
            >
                ...
                >
                    ...
                    <div>
                        <Button
                            variant="outlined"
                            onClick={getSelectionSortIntuited}
                        >
                            Selection Sort
                            <br />
                            (intuited)
                    ...
                    <div>
                        <Button
                            variant="outlined"
                            onClick={getInsertionSortIntuited}
                        >
                            Insertion Sort
                            <br />
                            (intuited)
                ...
                <div>
                    ...
                    {listSize && (
                        <Typography variant="subtitle2">
                            <b>List size</b>:{' '}
                            {Number(listSize).toLocaleString()}
                        </Typography>
                    )}
                </div>
                <div>
            ...
            >
                ...
                <DialogContent sx={{ paddingBottom: 0 }}>
                    ...
                    <form onSubmit={getList}>
                        ...
                        <DialogActions>
                            <Button onClick={handleCloseGetListDialog}>
                                Cancel
                            </Button>
